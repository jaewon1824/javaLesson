...
public class C23AnonymousClassTest {
    ...
    public static void main(String[] args) {
        ...
        // 재정의해야 할 메소드가 1개입니다. BeAble 인터페이스의 추상메소드가 1개입니다.
        //      ㄴ 함수형 인터페이스 : 람다식 (줄여서 쓰기)으로도 정의할 수 있습니다.
        ...
        //*함수형 인터페이스* 정의        (참고) function 키워드는 c언어, 자바스크립트 함수 정의에 사용 ex) 
        ...
        //      *자바에서 함수형 인터페이스를 익명클래스 형식으로 많이 사용합니다. (어노니머스) - 람다식 사용 가능.*
